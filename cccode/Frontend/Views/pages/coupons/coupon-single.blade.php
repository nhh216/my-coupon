...
<!-- Mirrored from psdconverthtml.com/live/yourcoupon/coupon-v1/coupon-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 09 Jan 2018 10:40:39 GMT -->
<head>
                    ...
                    <div class="navbar navbar-default" role="navigation">
                        ...
                        <div class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li><a class="active" href="coupons.html" title="">Coupons</a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 col-sm-8 col-xs-12">
                                    ...
                                    <div class="coupon-bottom clearfix">
                                        ...
                                        <small class="pull-right"><a href="store-single.html"><i class="fa fa-comment-o"></i> 3 Comments</a></small>
                                    </div><!-- end coupon-top -->
                                </div><!-- end col -->
                            </div><!-- end row -->
